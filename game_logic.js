var gameVariants = ["SSP", "SSPB"];
var currentGameVariant = gameVariants[0];
var symbolMap = { stone: 0, paper: 1, scissors: 2, well: 3 };
var leftWins = ["02", "10", "13", "21", "30", "32"]; // TODO add explaination/documentation
// HTML elements
...
var btnWell = document.getElementById("btnWell"); // maybe rename
function runGame(symbol) {
